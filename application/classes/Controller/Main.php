...
class Controller_Main extends Controller_Template {
	...
	*/
	...
	{
		$this->template->content = '<h1>hello, world!</h1> <p> This is the home page of Shopify custom images. An Etherton Technologies product.</p><p>This site is still under development</p>';
	}
	...
	*/
	...
	{
		if ($this->auto_render && $this->template->header != "")
		{						
